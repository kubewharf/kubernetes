...
var (
	...
	// ErrNodeUnderLoadPressure is used for NodeUnderLoadPressure predicate error.
	ErrNodeUnderLoadPressure = newPredicateFailureError("NodeUnderLoadPressure", "node(s) had load pressure")
