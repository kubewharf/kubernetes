...
type PriorityLevelConfigurationInterface interface {
	Create(*flowcontrol.PriorityLevelConfiguration) (*flowcontrol.PriorityLevelConfiguration, error)
	Update(*flowcontrol.PriorityLevelConfiguration) (*flowcontrol.PriorityLevelConfiguration, error)
	UpdateStatus(*flowcontrol.PriorityLevelConfiguration) (*flowcontrol.PriorityLevelConfiguration, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*flowcontrol.PriorityLevelConfiguration, error)
	List(opts v1.ListOptions) (*flowcontrol.PriorityLevelConfigurationList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *flowcontrol.PriorityLevelConfiguration, err error)
...
func newPriorityLevelConfigurations(c *FlowcontrolClient) *priorityLevelConfigurations {
...
func (c *priorityLevelConfigurations) Get(name string, options v1.GetOptions) (result *flowcontrol.PriorityLevelConfiguration, err error) {
	result = &flowcontrol.PriorityLevelConfiguration{}
	err = c.client.Get().
...
func (c *priorityLevelConfigurations) List(opts v1.ListOptions) (result *flowcontrol.PriorityLevelConfigurationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &flowcontrol.PriorityLevelConfigurationList{}
	err = c.client.Get().
		Resource("prioritylevelconfigurations").
...
func (c *priorityLevelConfigurations) Create(priorityLevelConfiguration *flowcontrol.PriorityLevelConfiguration) (result *flowcontrol.PriorityLevelConfiguration, err error) {
	result = &flowcontrol.PriorityLevelConfiguration{}
	err = c.client.Post().
		Resource("prioritylevelconfigurations").
...
func (c *priorityLevelConfigurations) Update(priorityLevelConfiguration *flowcontrol.PriorityLevelConfiguration) (result *flowcontrol.PriorityLevelConfiguration, err error) {
	result = &flowcontrol.PriorityLevelConfiguration{}
	err = c.client.Put().
		Resource("prioritylevelconfigurations").
...
func (c *priorityLevelConfigurations) UpdateStatus(priorityLevelConfiguration *flowcontrol.PriorityLevelConfiguration) (result *flowcontrol.PriorityLevelConfiguration, err error) {
	result = &flowcontrol.PriorityLevelConfiguration{}
	err = c.client.Put().
		Resource("prioritylevelconfigurations").
		Name(priorityLevelConfiguration.Name).
...
func (c *priorityLevelConfigurations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *flowcontrol.PriorityLevelConfiguration, err error) {
	result = &flowcontrol.PriorityLevelConfiguration{}
