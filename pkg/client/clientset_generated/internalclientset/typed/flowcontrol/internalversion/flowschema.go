...
type FlowSchemaInterface interface {
	Create(*flowcontrol.FlowSchema) (*flowcontrol.FlowSchema, error)
	Update(*flowcontrol.FlowSchema) (*flowcontrol.FlowSchema, error)
	UpdateStatus(*flowcontrol.FlowSchema) (*flowcontrol.FlowSchema, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*flowcontrol.FlowSchema, error)
	List(opts v1.ListOptions) (*flowcontrol.FlowSchemaList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *flowcontrol.FlowSchema, err error)
	FlowSchemaExpansion
}
...
func newFlowSchemas(c *FlowcontrolClient) *flowSchemas {
	return &flowSchemas{
		client: c.RESTClient(),
	}
}
...
func (c *flowSchemas) Get(name string, options v1.GetOptions) (result *flowcontrol.FlowSchema, err error) {
	result = &flowcontrol.FlowSchema{}
	err = c.client.Get().
...
func (c *flowSchemas) List(opts v1.ListOptions) (result *flowcontrol.FlowSchemaList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &flowcontrol.FlowSchemaList{}
	err = c.client.Get().
		Resource("flowschemas").
...
func (c *flowSchemas) Create(flowSchema *flowcontrol.FlowSchema) (result *flowcontrol.FlowSchema, err error) {
	result = &flowcontrol.FlowSchema{}
	err = c.client.Post().
		Resource("flowschemas").
		Body(flowSchema).
...
func (c *flowSchemas) Update(flowSchema *flowcontrol.FlowSchema) (result *flowcontrol.FlowSchema, err error) {
	result = &flowcontrol.FlowSchema{}
	err = c.client.Put().
		Resource("flowschemas").
...
func (c *flowSchemas) UpdateStatus(flowSchema *flowcontrol.FlowSchema) (result *flowcontrol.FlowSchema, err error) {
	result = &flowcontrol.FlowSchema{}
	err = c.client.Put().
		Resource("flowschemas").
		Name(flowSchema.Name).
...
func (c *flowSchemas) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *flowcontrol.FlowSchema, err error) {
	result = &flowcontrol.FlowSchema{}
