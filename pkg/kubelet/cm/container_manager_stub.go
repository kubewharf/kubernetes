...
func (cm *containerManagerStub) Start(_ *v1.Node, _ ActivePodsFunc, _ ActivePodsFunc, _ config.SourcesReady, _ status.PodStatusProvider, _ internalapi.RuntimeService) error {
