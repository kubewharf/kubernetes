...
type Stub struct {
	...
	// handling allocation for pod request
	allocForPodFunc stubAllocForPodFunc
...
// stubAllocForPodFunc is the function called when a pod allocation request is received from Kubelet
type stubAllocForPodFunc func(r *pluginapi.PodResourceRequest) (*pluginapi.PodResourceAllocationResponse, error)
...
func defaultAllocForPodFunc(r *pluginapi.PodResourceRequest) (*pluginapi.PodResourceAllocationResponse, error) {
	var response pluginapi.PodResourceAllocationResponse
	return &response, nil
}
...
func NewResourcePluginStub(socket string, name string, preStartContainerFlag bool) *Stub {
	return &Stub{
		...
		allocForPodFunc: defaultAllocForPodFunc,
	}
}
...
func (m *Stub) SetAllocForPodFunc(f stubAllocForPodFunc) {
	m.allocForPodFunc = f
}
