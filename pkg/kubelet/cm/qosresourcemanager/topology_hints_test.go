...
func makeGetResourcesFromPodFunc(resourceName, resourceQuantity string) GetPodResourcesFunc {
	return func(pod *v1.Pod) v1.ResourceRequirements {
		return v1.ResourceRequirements{
			Limits: v1.ResourceList{
				v1.ResourceName(resourceName): resource.MustParse(resourceQuantity),
			},
		}
	}
}
