	...
	tests := []struct {
	...
	}{
		{
			...
			mergedTolerations: []api.Toleration{
				...
				{Key: "node.kubernetes.io/memory-pressure", Operator: "Exists", Effect: "NoSchedule", TolerationSeconds: nil},
			},
			admit:    true,
		...
		},
		{
			...
			mergedTolerations: []api.Toleration{
				{Key: "testKey", Operator: "Equal", Value: "testValue", Effect: "NoSchedule"},
				{Key: "testKey", Operator: "Equal", Value: "testValue1", Effect: "NoSchedule"},
				{Key: "node.kubernetes.io/memory-pressure", Operator: "Exists", Effect: "NoSchedule", TolerationSeconds: nil},
			},
			admit:    true,
		...
		},
		{
			...
			namespaceTolerations:      []api.Toleration{},
			podTolerations:            []api.Toleration{},
			mergedTolerations:         []api.Toleration{{Key: "node.kubernetes.io/memory-pressure", Operator: "Exists", Effect: "NoSchedule", TolerationSeconds: nil}},
			admit:                     true,
