...
var map_ListOptions = map[string]string{
	...
	"shardingIndex":       "The shardingIndex is an int range from 0 to ShardingCount-1.",
	"shardingCount":       "The shardingCount is the number of total sharding.",
	"shardingLabelKey":    "The key of label whose value will be hashed.",
	"hashFunc":            "HashFunc indicates the algorithm we map a string to a int64, for now we only support FNV32, it will be extended in the future.",
}
