...
type Device struct {
	...
	Properties           map[string]string `protobuf:"bytes,101,rep,name=properties,proto3" json:"properties,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "v1beta1.Device.PropertiesEntry")
