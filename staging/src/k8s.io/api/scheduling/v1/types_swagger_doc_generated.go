...
var map_PriorityClass = map[string]string{
	...
	"canBePreempted": "CanBePreempted indicates whether the pods with this priority class value can be preempted. For safety reasons， the default value is false.",
}
