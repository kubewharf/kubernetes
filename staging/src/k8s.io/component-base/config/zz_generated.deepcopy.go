...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IndexConfiguration) DeepCopyInto(out *IndexConfiguration) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IndexConfiguration.
func (in *IndexConfiguration) DeepCopy() *IndexConfiguration {
	if in == nil {
		return nil
	}
	out := new(IndexConfiguration)
	in.DeepCopyInto(out)
	return out
}
